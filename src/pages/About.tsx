...
export default function About() {
  useDocumentHead({
    title: 'Über uns',
    description: `Aeranto ist die Flugbuchungsplattform der ${company.legalName} — Ground-Handling-Erfahrung vom Hamburg Airport, jetzt in Ihrer Buchung.`,
  });
    ...
    <div ref={ref} className="pt-16 md:pt-[72px]">
      <section className="bg-navy-900 py-16 lg:py-24">
        <div className="container-page max-w-3xl" data-reveal>
          ...
          <p className="mt-5 text-body-lg text-navy-100">
            Die {company.legalName} arbeitet seit Jahren im Ground Handling am Hamburg Airport. Wir wissen, warum Flüge pünktlich sind — und warum nicht. Diese Erfahrung macht Aeranto zur Flugbuchung, auf die Sie sich verlassen können.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="container-page">
          <div data-reveal>
            <SectionHeading eyebrow="Zahlen" title="Aeranto in Kennzahlen" />
          </div>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <div data-reveal data-reveal-delay="120">
            ...
            <p className="mt-4 max-w-prose text-body text-neutral-600">
              Unsere Teams beladen Flugzeuge, lotsen sie an ihre Positionen und sorgen dafür, dass Abflüge pünktlich starten. Wenn Sie bei Aeranto buchen, profitieren Sie von diesem Wissen: realistische Umsteigezeiten, ehrliche Flugzeiten, klare Preise.
            </p>
            <p className="mt-4 max-w-prose text-body text-neutral-600">
