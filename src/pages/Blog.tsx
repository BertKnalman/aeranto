...
const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      'Prüfen Sie die Handgepäck-Maße Ihrer Airline vor Abflug: Gerade Billigflieger messen am Gate nach. Die genauen Regeln Ihres Fluges finden Sie in Ihrer Aeranto-Buchungsbestätigung.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Bei Aeranto zeigen wir nur Verbindungen, die wir selbst für realistisch halten — das ist der Vorteil, wenn das Buchungsteam weiß, wie lange ein Pushback wirklich dauert.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Bei Aeranto sehen Sie alle vier Klassen direkt im Preisvergleich. Rechnen Sie ehrlich: Was ist Ihnen ein ausgeruhter Ankunftstag wert?',
    ],
    author: 'Janne Petersen',
    authorRole: 'Leitung Bodenverkehrsdienste',
  },
...
export default function Blog() {
  ...
  useDocumentHead({
    ...
    description: openArticle
      ? openArticle.excerpt
      : 'Der Aeranto-Blog: Reisetipps, Fluggastrechte und Insider-Wissen vom Hamburg Airport.',
  });
        ...
        <article className="container-page max-w-[760px] py-12">
          ...
          <footer className="mt-10 flex items-center gap-4 rounded-lg border border-neutral-200 bg-white p-5">
            ...
            <div>
              ...
              <p className="text-caption text-neutral-500">{openArticle.authorRole}, Aeranto Hamburg</p>
            </div>
          </footer>
        </article>
      </div>
