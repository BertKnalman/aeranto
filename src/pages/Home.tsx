...
const TESTIMONIALS = [
  ...
  { quote: 'Ich buche dienstlich viel. Aeranto ist das erste Portal, das sich anfühlt, als hätte jemand mit Ahnung vom Flugbetrieb gebaut.', name: 'Dr. Sabine L.', route: 'HAM → JFK' },
];

export default function Home() {
  useDocumentHead({
    title: 'Aeranto – Premium Flugbuchung | Ihr Flug. Präzise geplant.',
    description: 'Aeranto – Flüge buchen ohne Umwege. Transparente Preise, sichere Zahlung über SumUp und persönliche Betreuung aus Hamburg.',
  });
    ...
    <div ref={revealRef}>
      ...
      <section className="relative flex h-[88vh] min-h-[560px] items-center justify-center overflow-hidden bg-navy-950">
        ...
        <div className="container-page relative z-10 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-body-lg text-navy-100">
            Aeranto findet Ihren Flug — transparente Preise, sichere Buchung, persönliche Betreuung aus Hamburg.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-16 lg:py-24" aria-labelledby="warum-title">
        <div className="container-page grid items-center gap-12 lg:grid-cols-2">
          <div data-reveal>
            <p className="text-caption font-semibold uppercase tracking-wider text-gold-600">Warum Aeranto</p>
            <h2 id="warum-title" className="mt-2 text-display-sm md:text-display-md">
              Warum Reisende Aeranto vertrauen
            </h2>
