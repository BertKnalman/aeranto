...
export type LegalPageKey = 'impressum' | 'agb' | 'datenschutz' | 'cookies' | 'barrierefreiheit' | 'stornierung' | 'erstattung';
...
const PAGES: Record<LegalPageKey, LegalPage> = {
  impressum: {
    title: 'Impressum',
    stand: 'Stand: 10.09.2026',
    description: 'Impressum und Anbieterkennzeichnung der Flugbuchungsplattform Aeranto.',
    sections: [
      {
        h: 'Angaben gemäß § 5 DDG',
        p: [
          `Aeranto ist eine Marke der ${company.legalName}, ${company.address.street}, ${company.address.zip} ${company.address.city}, ${company.address.country}.`,
      ...
      },
      {
        h: 'Registereintrag',
        p: [
          `Handelsregister: ${company.registerCourt}, ${company.commercialRegister}. Umsatzsteuer-Identifikationsnummer gemäß § 27a UStG: ${company.vatId}.`,
        ],
      },
      {
      ...
      },
      {
        h: 'Streitschlichtung',
        p: [
          'Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit. Wir sind nicht bereit und nicht verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.',
        ],
      },
    ],
  },
  agb: {
    ...
    description: `AGB der ${company.legalName} für die Flugbuchungsplattform Aeranto.`,
    sections: [
      {
        h: '§ 1 Geltungsbereich und Vertragspartner',
        p: [
          `Diese Allgemeinen Geschäftsbedingungen gelten für die Nutzung der Flugbuchungsplattform Aeranto, betrieben von der ${company.legalName} (nachfolgend „Aeranto"), ${company.address.street}, ${company.address.zip} ${company.address.city}.`,
          'Aeranto vermittelt Beförderungsverträge zwischen dem Kunden und der jeweiligen Fluggesellschaft. Der Beförderungsvertrag kommt ausschließlich zwischen dem Kunden und der Airline zustande; es gelten ergänzend die Beförderungsbedingungen der jeweiligen Airline.',
        ],
      },
      {
        h: '§ 2 Vertragsschluss',
      ...
      },
      {
        h: '§ 6 Haftung',
        p: [
          'Aeranto haftet für die ordnungsgemäße Vermittlung des Beförderungsvertrags. Für die Durchführung der Beförderung selbst haftet ausschließlich die ausführende Airline.',
  ...
  cookies: {
    ...
    stand: 'Stand: 01.09.2025',
    description: 'Cookie-Richtlinie von Aeranto: welche Cookies und Speicher wir einsetzen und warum.',
    sections: [
      {
        h: '1. Grundsatz',
        p: [
          'Aeranto setzt ausschließlich technisch notwendige Speichermechanismen ein. Wir verwenden keine Marketing-Cookies, kein Tracking und keine Analyse-Tools von Drittanbietern.',
        ],
      },
      {
  ...
  barrierefreiheit: {
    ...
    stand: 'Stand: 01.09.2025',
    description: 'Erklärung zur Barrierefreiheit der Aeranto-Website nach BFSG und WCAG 2.2 AA.',
    sections: [
      {
        h: '1. Unser Anspruch',
        p: [
          `${company.legalName} ist bemüht, die Flugbuchungsplattform Aeranto im Einklang mit dem Barrierefreiheitsstärkungsgesetz (BFSG) und den Web Content Accessibility Guidelines (WCAG) 2.2, Konformitätsstufe AA, barrierefrei zugänglich zu machen.`,
        ],
      },
      {
  ...
  stornierung: {
    ...
    stand: 'Stand: 01.09.2025',
    description: 'Stornierungsbedingungen von Aeranto: kostenlose Stornierung bis 24 Stunden vor Abflug.',
    sections: [
      {
        h: '1. Kostenlose Stornierung',
        p: [
          'Sie können jede über Aeranto gebuchte Buchung bis 24 Stunden vor dem planmäßigen Abflug kostenfrei stornieren. Sie erhalten den vollständigen Buchungsbetrag zurück — ohne Stornogebühr.',
        ],
      },
      {
  ...
  erstattung: {
    ...
    stand: 'Stand: 01.09.2025',
    description: 'Erstattungsrichtlinie von Aeranto: Fristen, Wege und Ihre Rechte nach EG 261/2004.',
    sections: [
      {
