  ...
  return (
    <div ref={ref} className="pt-16 md:pt-[72px]">
      <section className="bg-navy-900 py-16 lg:py-24">
        <div className="container-page max-w-3xl" data-reveal>
          ...
          <p className="mt-5 text-body-lg text-navy-100">
            Vom Vorfeld des Hamburg Airport ins Produkt: Bei Aeranto arbeiten Menschen, die Luftfahrt nicht aus dem Lehrbuch kennen, sondern aus der Praxis. Hanseatisch im Ton, präzise in der Sache.
          </p>
        </div>
      </section>
      ...
      <section className="container-page py-16 lg:py-24">
        <div data-reveal>
          <SectionHeading eyebrow="Offene Stellen" title="Aktuelle Positionen" sub="Alle Bewerbungen bitte an karriere@aeranto.com — Betreff: Position + Ihr Name." />
        </div>
        <ul className="mt-10 space-y-4">
          {JOBS.map((j, i) => (
            ...
            >
              ...
              <a
                href={`mailto:karriere@aeranto.com?subject=${encodeURIComponent(`Bewerbung: ${j.title}`)}`}
        ...
        <p className="mt-8 text-body-sm text-neutral-500" data-reveal>
          ...
          <a href="mailto:karriere@aeranto.com" className="font-semibold text-navy-600 underline underline-offset-4">
            karriere@aeranto.com
          </a>
        </p>
      </section>
    </div>
