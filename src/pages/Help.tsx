...
const FAQS: Faq[] = [
  { category: 'buchung', q: 'Wie buche ich einen Flug bei Aeranto?', a: 'Geben Sie auf der Startseite Abflug- und Zielflughafen sowie Ihr Reisedatum ein. Wählen Sie aus den Ergebnissen einen Flug, tragen Sie die Passagierdaten ein und bezahlen Sie sicher über SumUp. Die Bestätigung erhalten Sie sofort per E-Mail.' },
  ...
  { category: 'storno', q: 'Wie storniere ich meine Buchung?', a: 'Unter „Meine Buchungen“ wählen Sie die Buchung und klicken auf „Stornieren“. Alternativ genügt eine E-Mail an info@aeranto.com mit Ihrer Buchungsreferenz.' },
...
export default function Help() {
  ...
  useDocumentHead({
    title: 'Hilfe & FAQ',
    description: 'Antworten auf häufige Fragen zu Buchung, Zahlung, Stornierung und Gepäck — und direkter Kontakt zum Aeranto-Support aus Hamburg.',
  });
