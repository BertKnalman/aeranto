...
const BOOKINGS_KEY = 'aeranto_bookings';
...
const USERS_KEY = 'aeranto_users';
const SESSION_KEY = 'aeranto_session';
...
export const ADMIN_EMAIL = 'admin@aeranto.com';
export const ADMIN_PASSWORD = 'admin123';
const ADMIN_KEY = 'aeranto_admin';
